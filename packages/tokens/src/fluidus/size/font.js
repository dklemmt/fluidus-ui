...
module.exports = {
  size: {
    font: {
      body: {
        xsmall: {
          fontSize: { value: "clamp(0.7813rem, 0.7747rem + 0.0326vw, 0.8rem)" },
          // lineHeight: { value: "20px" },
        },
        small: {
          fontSize: { value: "clamp(0.9375rem, 0.9158rem + 0.1087vw, 1rem)" },
          lineHeight: { value: "1.3" },
        },
        medium: {
          fontSize: { value: "clamp(1.125rem, 1.0815rem + 0.2174vw, 1.25rem)" },
