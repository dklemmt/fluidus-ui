...
export const Component = () => (
  <>
    ...
    <Paragraph>
      Telefon: +49-163-2496374
      <br />
      E-Mail: <a href="mailto:ninahaas@gmx.de">ninahaas@gmx.de</a>
    </Paragraph>
    <Paragraph>
      <strong>Berufshaftpflichtversicherung:</strong> Berufshaftpflicht
      <br />
    ...
    <Paragraph>
      ...
      <a href="mailto:ninahaas@gmx.de">ninahaas@gmx.de</a>
    </Paragraph>
    <Paragraph>
    ...
    <Heading size="large">Disclaimer – rechtliche Hinweise</Heading>
    <Heading size="medium">§ 1 Warnhinweis zu Inhalten</Heading>
    <Paragraph>
    ...
    <Heading size="medium">§ 2 Externe Links</Heading>
    <Paragraph>
    ...
    <Heading size="medium">§ 3 Urheber- und Leistungsschutzrechte</Heading>
    <Paragraph>
    ...
    <Heading size="medium">§ 4 Besondere Nutzungsbedingungen</Heading>
    <br />
    <Paragraph>
    ...
    <Paragraph>
      Quelle: <a href="https://www.juraforum.de">Link hier klicken</a>
    </Paragraph>
  </>
);
